...
/// <summary>
/// Integration tests for the read-audit feature on PostgreSQL.
...
public sealed class PostgreSqlReadAuditTests : IAsyncLifetime
{
    ...
    public PostgreSqlReadAuditTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task EndToEnd_AuditReadsOn_HttpGet_WritesReadRowToAuditTable()
    {
        ...
        found.ShouldBeTrue("Read audit row should have been written to the PostgreSQL audit table.");
    }
