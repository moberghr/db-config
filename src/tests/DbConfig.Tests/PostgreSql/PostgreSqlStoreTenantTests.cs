...
/// <summary>
/// Integration tests for tenant-aware store methods on PostgreSQL (B54).
...
public sealed class PostgreSqlStoreTenantTests : IAsyncLifetime
{
    ...
    public PostgreSqlStoreTenantTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
