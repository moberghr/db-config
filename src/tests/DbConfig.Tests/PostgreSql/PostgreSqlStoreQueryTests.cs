...
public sealed class PostgreSqlStoreQueryTests : IAsyncLifetime
{
    ...
    public PostgreSqlStoreQueryTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    private EfCoreConfigStore BuildLoggingStore(StringBuilder sqlLog)
    {
        ...
        return new EfCoreConfigStore(factory, new PostgreSqlUniqueConstraintDetector(), TimeProvider.System);
    }
}
