...
/// <summary>
/// Integration tests for the composed scope × tenant store methods (B64) on SQL Server.
...
public sealed class SqlServerStoreScopedTenantTests : IAsyncLifetime
{
    ...
    public SqlServerStoreScopedTenantTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
