...
public sealed class SqlServerStoreEncryptionTests : IAsyncLifetime
{
    ...
    public SqlServerStoreEncryptionTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task IsSecretFlippedFalseAfterEncryption_GetAsyncReturnsCiphertextAsValue()
    {
        ...
        // the store will write plaintext. To simulate a "flipped bit" scenario we need to
