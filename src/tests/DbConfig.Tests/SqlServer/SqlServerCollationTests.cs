...
/// <summary>
/// Verifies that AppName, Environment, and Key columns use case-sensitive binary collation
/// (Latin1_General_100_BIN2) on SQL Server after the B25 migration.
...
public sealed class SqlServerCollationTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private EfCoreConfigStore _store = null!;

    public SqlServerCollationTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
